// lexer.js — tokenizes .arch source into a token stream

const KEYWORDS = new Set([
  'arch', 'layer', 'rule', 'flow', 'convention', 'context',
  'version', 'stack', 'language',
  'path', 'description', 'can', 'import', 'require', 'directive',
  'readonly', 'severity', 'forbid', 'pattern', 'except', 'in',
